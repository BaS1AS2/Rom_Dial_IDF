...
static void lv_port_indev_init(void) {
    ...
    // indev_drv.long_press_repeat_time = 500;    // 间隔 0.5s
    // 发送LV_EVENT_LONG_PRESSED_REPEAT 事件
...
void ui_init(void) {
    ...
    switch (sys_config.set_frist_screen) {
        ...
        case 2:
            ...
            break;
        case 3:
            ui_Screen_Led_Ring_screen_init();
            lv_disp_load_scr(ui_Led_Ring);
            break;
        default:
            lv_disp_load_scr(ui_Screen1);
            break;
